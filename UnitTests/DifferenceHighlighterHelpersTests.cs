...
namespace ShouldBe.UnitTests
{
    ...
    {
        private static string NewLineDelimited(string expected)
        {
            // enumerations are now delimited by newlines but this makes the unit test hard to read so we fix it all here.
        ...
        {
            new[] { 2, 2, 3 }.HighlightDifferencesBetween(new[] { 1, 2, 3 }).ShouldBe(NewLineDelimited("{*2*, 2, 3}"));
        }

        [Test]
        public void HighlightDifferencesBetween_ListsSame_DisplaysActualWithoutHighlight()
        {
            new[] { 1, 2, 3 }.HighlightDifferencesBetween(new[] { 1, 2, 3 }).ShouldBe(NewLineDelimited("{1, 2, 3}"));
        }

        [Test]
        public void HighlightDifferencesBetween_ListsActualHasMoreElements_HighlightsMissingElements()
        {
            new[] { 1, 2, 3 }.HighlightDifferencesBetween(new[] { 1 }).ShouldBe(NewLineDelimited("{1, *2*, *3*}"));
        }

        [Test]
        public void HighlightDifferencesBetween_ListsActualHasLessElements_HighlightsMissingElements()
        {
            new[] { 1 }.HighlightDifferencesBetween(new[] { 1, 2, 3 }).ShouldBe(NewLineDelimited("{1, *, *}"));
        }
        ...
        {
            new[] { 2, 3, 1 }.HighlightDifferencesBetween(new[] { 1, 2, 3 }).ShouldBe(NewLineDelimited("{*2*, *3*, *1*}"));
        }

        [Test]
        public void HighlightDifferencesBetween_StringLists_HighlightsDifference()
        {
            new[] { "rita", "sue", "betty" }.HighlightDifferencesBetween(new[] { "rita", "sue", "bob" }).ShouldBe(NewLineDelimited("{\"rita\", \"sue\", *\"betty\"*}"));
        }

        [Test]
        public void HighlightDifferencesBetween_EnumLists_HighlightsDifference()
        {
            new[] { Weapons.Screwdriver, Weapons.Axe }.HighlightDifferencesBetween(new[] { Weapons.Chainsaw, Weapons.Axe }).ShouldBe(NewLineDelimited("{*Weapons.Screwdriver*, Weapons.Axe}"));
        }

        [Test]
        public void HighlightDifferencesBetween_BoolLists_HighlightsDifference()
        {
            new[] { true, true, false }.HighlightDifferencesBetween(new[] { true, false, true }).ShouldBe(NewLineDelimited("{true, *true*, *false*}"));
        }
        ...
        public void HighlightDifferencesBetween_ListOfObjectWithEqualsDefined_HighlightsDifference()
        {
            new[] { new EqualType("t1"), new EqualType("t3") }
               ...
               .ShouldBe(NewLineDelimited("{t1, *t3*}"));
        }
        ...
        public void HighlightDifferencesBetween_ListOfObjectWithoutEqualsDefined_HighlightsEverythingAsDifference()
        {
            new[] { new NonEqualType("t1"), new NonEqualType("t2") }
                .HighlightDifferencesBetween(
               new[] { new NonEqualType("t1"), new NonEqualType("t2") })
               .ShouldBe(NewLineDelimited("{*t1*, *t2*}"));
        }

        [Test]
        public void HighlightDifferencesBetween_GenericList_HighlightsDifference()
        {
            new List<int> { 1, 4, 3 }.HighlightDifferencesBetween(new List<int> { 1, 2, 3 }).ShouldBe(NewLineDelimited("{1, *4*, 3}"));
        }

        [Test]
        public void HighlightDifferencesBetween_ArrayList_HighlightsDifference()
        {
            new ArrayList { 9, 7, 8 }.HighlightDifferencesBetween(new ArrayList { 9, 8, 7 }).ShouldBe(NewLineDelimited("{9, *7*, *8*}"));
        }

        [Test]
        public void HighlightDifferencesBetween_PureEnumerable_HighlightsDifference()
        {
            new PureEnumerable { 9, 8, 6 }.HighlightDifferencesBetween(new PureEnumerable { 9, 8, 7 }).ShouldBe(NewLineDelimited("{9, 8, *6*}"));
        }
