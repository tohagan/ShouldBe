...
namespace ShouldBe.UnitTests
{
    ...
    {
        [Test]
        public void ShouldContain_WhenTrue_ShouldSucceed()
        {
        ...
        [Test]
        public void ShouldNotContain_WhenTrue_ShouldSucceed()
        {
        ...
        [Test]
        public void ShouldContain_WithPredicate_WhenTrue_ShouldSucceed()
        {
        ...
        [Test]
        public void ShouldNotContain_WithPredicate_WhenTrue_ShouldSucceed()
        {
        ...
        [Test]
        public void ShouldBeTheSet_WithAddedAndRemovedElements_ShouldErrorWithMessage()
        {
            TestHelper.ShouldFailWithError(() => 
